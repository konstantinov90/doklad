...
1. {:.next}Одна из библиотек интернационализации `enb‑bem‑i18n` или `@yandex‑int/i18n`
1. {:.next}Проект в tanker.yandex-team.ru
1. {:.next}`tanker‑kit` для синхронизации с танкером
1. {:.next}Автоматика для ночной синхронизации
